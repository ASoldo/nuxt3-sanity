<template>
  ...
  <dialog ref="fullScreenQR" class="w-full h-full md:w-2/3 mx-auto mt-20">
    <div class="text-white bg-kaufland-red border rounded-xl shadow-xl relative flex flex-col justify-center items-center gap-6 p-2">
